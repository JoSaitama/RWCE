...
def initialize(parser):
  ...
  parser.add_argument('--RAPS_lambda', default = 0.01, type = float, help = 'hyperparameter lambda for RAPS score')
  parser.add_argument('--RAPS_kreg', default = 5, type = int, help = 'hyperparameter kreg for RAPS score')

  # hyperparameter for training IWCE method
  parser.add_argument('--IWCE_rank_exponent', default = 1, type = float, help = 'total number of epochs')
